      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="密码最小长度">
            <el-input v-model="form.password_min" type="number" placeholder="密码最小长度" style="width: 30%;"></el-input>
          </el-form-item>
        ...
        <el-tab-pane label="上传设置" name="second">
          ...
          <el-form-item label="空间域名">
            <el-input v-model="form.upload_config.http" placeholder="http" style="width: 30%;" clearable></el-input>
            <small class="text-gray-400 flex mt-1">请补全http://或https://</small>
          </el-form-item>
        </el-tab-pane>
        <!-- Api安全板块 -->
        <el-tab-pane label="Api安全" name="three">
          <el-form-item label="是否开启API安全">
            ...
            <small class="text-gray-400 flex">api安全功能开启之后调用前端api需要传输签名串</small>
          </el-form-item>
          <el-form-item label="秘钥">
            <el-input v-model="form.api_secret" placeholder="秘钥" style="width: 30%;" clearable></el-input>
            <small class="text-gray-400 flex">秘钥设置关系系统中api调用传输签名串的编码规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录获取token</small>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>
      <!-- 保存按钮 -->
...
const form = reactive({
  open_reg: 1,//开启注册
  reg_method: 'username',//注册方法
  password_min: 0,//密码最小长度
  password_encrypt: [],//密码复杂程度
