  ...
  <el-drawer :title="drawerTitle" v-model="dialogVisible" size="70%">
    ...
    <el-table :data="tableData" stripe width="100%" v-loading="loading">
      <template v-if="type === 'user'">
        <!-- 第1列 -->
        <el-table-column label="UID" prop="id" align="centter" />
        <!-- 第2列 头像 -->
        ...
        <el-table-column label="推广数量" prop="share_num" align="center" width="120" />
        <el-table-column label="推广订单数" prop="share_order_num" align="center" width="120" />
        <el-table-column label="绑定时间" prop="create_time" align="center" width="120" />
      </template>
      <template v-else>
        <!-- 第1列 -->
